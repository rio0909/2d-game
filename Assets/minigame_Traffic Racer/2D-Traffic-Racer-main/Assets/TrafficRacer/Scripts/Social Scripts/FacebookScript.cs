...
public class FacebookScript : MonoBehaviour {
    ...
    private void Start()
    {
        ...
        else
        {
            ...
            if (TrafficGameManager.instance.fbConnected == true && FB.IsLoggedIn == false)
            {
        ...
        if (TrafficGameManager.instance.shareReward == true)
        {
            GuiManager.instance.facebookElements.shareBtnText.text = "Share with your friends";
        }

        if (TrafficGameManager.instance.likeReward == true)
        {
    ...
    {
        if (TrafficGameManager.instance.likeReward == false)
        {
            SetReward(200);
            TrafficGameManager.instance.likeReward = true;
    ...
    public void CollectCoinsBtn()
    {
        ...
        TrafficGameManager.instance.coinAmount += rewardCoins;
        TrafficGameManager.instance.Save();
...
#region Login Logout
    ...
    public void FacebookLogout()
    {
        ...
        FB.LogOut();
        #endif
        TrafficGameManager.instance.fbConnected = false;
        TrafficGameManager.instance.Save();
        GuiManager.instance.facebookElements.fbPanel.SetActive(false);
    }
#endregion
...
#region CallBack methods
    ...
    private void AuthCallback(ILoginResult result)
    {
        if (FB.IsLoggedIn)
        {
            ...
            if (TrafficGameManager.instance.fbConnected == false)
            {
                ...
                if (TrafficGameManager.instance.loginReward == false)
                {
                    SetReward(200);
                    TrafficGameManager.instance.loginReward = true;
                }

                TrafficGameManager.instance.fbConnected = true;
                TrafficGameManager.instance.Save();
            }
            else if (TrafficGameManager.instance.fbConnected == true)
            {
                GetProfilePic();
            }
    ...
    private void ShareLinkCallback(IShareResult result)
    {
        ...
        else
        {
            ...
            if (TrafficGameManager.instance.shareReward == false)
            {
                GuiManager.instance.facebookElements.shareBtnText.text = "Share with your friends";
                SetReward(400);
                TrafficGameManager.instance.shareReward = true;
                TrafficGameManager.instance.Save();
            }
        }
    }
